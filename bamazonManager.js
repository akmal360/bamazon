...
function displayInventory() {
    ...
    connection.query(queryStr, function(err, data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            strOut += 'Quantity: ' + data[i].stock_of_quantity + '\n';
...
function displayLowInventory() {
    ...
    // Construct the db query string
    queryStr = 'SELECT * FROM products WHERE stock_of_quantity < 50';
    ...
    inquirer.prompt([{
        ...
        connection.query(queryStr, { item_id: item }, function(err, data) {
            ...
            if (data.length === 0) {
                ...
                // console.log('productData.stock_of_quantity = ' + productData.stock_of_quantity);

                console.log('Updating Inventory...');

                // Construct the updating query string
                var updateQueryStr = 'UPDATE products SET stock_of_quantity = ' + (productData.stock_of_quantity + addQuantity) + ' WHERE item_id = ' + item;
                ...
                connection.query(updateQueryStr, function(err, data) {
                    ...
                    console.log('Stock count for Item ID ' + item + ' has been updated to ' + (productData.stock_of_quantity + addQuantity) + '.');
                    console.log("\n---------------------------------------------------------------------\n");
...
function createNewProduct() {
    ...
    inquirer.prompt([{
        ...
        console.log('Adding New Item: \n    product_name = ' + input.product_name + '\n' +
            ...
            '    price = ' + input.price + '\n' +
            '    stock_of_quantity = ' + input.stock_of_quantity);
